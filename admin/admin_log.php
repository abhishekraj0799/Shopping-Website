...
.action_block_content{
  ...
  border-radius:70px;
  padding:4px 30px;
  box-shadow:1px 1px 7px 1px rgba(144,144,144,.25)
}
.action_block_content:hover{
  background-color:#eeeeee !important;
  cursor:pointer;
}
.action_block_content:focus,.action_block_content:active{
      ...
      <body>  
           ...
           <div class="container hmm" style="width:500px;">  
                ...
                <form method="post">  
                     ...
                     <br />  
                     <p align="center"><a href="seller.php">Become a seller</a> or <a href="admin_log.php?action=login">Log In now</a>.</p>  
