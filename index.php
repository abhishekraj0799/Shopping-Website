...
$connect = mysqli_connect("localhost", "root", "", "test");
 ...
 {  
           ...
           $username = mysqli_real_escape_string($connect, $_POST["username"]);  // here we are changing each data in the form of string
        ...
        $res= mysqli_query($connect,"select * from users where username='$username' ");// username is unique and also user id
 ...
 {  
           ...
           {  
             ...
             /*  echo "$row[0] $row[1] $row[3]";  */
                          ...
                          //return true;  
                          $_SESSION["username"] = $username;  //session is global variable it can be access any where ,, until it closes...          
